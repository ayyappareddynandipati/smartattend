...
The S79 Attendance System is a modern, AI-powered solution that automates classroom attendance using facial recognition technology. It supports real-time multi-face detection, enabling accurate and contactless attendance marking for educational institutions.
...
```bash
git clone https://github.com/ayyappareddynandipati/smartattend.git
cd smartattend
```
